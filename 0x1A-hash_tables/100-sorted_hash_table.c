 ...
 *         Else - points to the new sorted hash table.
 */
shash_table_t *shash_table_create(unsigned long int size)
{
	shash_table_t *ht;
 ...
 * @value: The val associated with key.
 *
...
/**
 * shash_table_get - gets the val asociated by
 *                   a key in a sorted hash table.
 * @ht: Points to the sorted hash table.
 * @key: The key to get the val 
 *
 * Return: If the key can't be matched - NULL.
 *         Else - the val associated with key in ht.
 */
char *shash_table_get(const shash_table_t *ht, const char *key)
{
	shash_node_t *node;
